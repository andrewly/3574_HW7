...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    offsetof(qt_meta_stringdata_SslServer_t, stringdata) + ofs \
...
const QMetaObject SslServer::staticMetaObject = {
    { &QTcpServer::staticMetaObject, qt_meta_stringdata_SslServer.data,
      qt_meta_data_SslServer,  qt_static_metacall, 0, 0}
};
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_SslServer.stringdata))
